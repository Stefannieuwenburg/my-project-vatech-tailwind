  ...
  <>
    <section className="bg-white py-16 px-6 md:px-12 lg:px-24 text-gray-800">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="mb-4">
          We zorgen ervoor dat jouw site precies aansluit bij jouw wensen en stijl. Geen grenzen, alleen mogelijkheden.
        </p>
        <p className="mb-4">
          Met een unieke website behoud je je identiteit en heb je de vrijheid om alles zelf in te richten. ik bouwen voornamelijk in <span className="font-medium">wix.com</span> en met <span className="font-medium">React met tailwind css framework </span>,voor op maat gemaakte websites met een door mijzelf ontwikkelde basis die zorgt voor snelle, veilige en flexibele websites.
        </p>
        <p className="mb-4">
          Ondanks maatwerk kunnen we snel ontwikkelen en kosten besparen. Het beste van twee werelden: maatwerk websites voor een betaalbare investering!
        </p>
        <button onClick={handleContactClick} className="bg-[#F37021] text-white px-6 py-3 rounded hover:bg-orange-600 transition">
