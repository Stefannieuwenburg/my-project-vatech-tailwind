      ...
      <>
          <section className="bg-white py-16 px-6 md:px-12 lg:px-24 text-gray-800">
              <div className="max-w-5xl mx-auto">
                  ...
                  <p className="mb-4">
                      Met een unieke website behoud je je identiteit en heb je de vrijheid om alles zelf in te richten.
                      ik bouwen voornamelijk in <span className="font-medium">wix.com</span> en met{" "}
          ...
          <section className="bg-[#F6E4D4] rounded-full py-16 px-6 md:px-12 lg:px-24 text-gray-800">
              ...
              <a
                  ...
                  href="https://wa.me/31626142085?text=Hi%20Stefan%2C%20I%20found%20your%20link%20and%20wanted%20to%20connect!"
              >
                  <img className="w-16 h-auto" alt="Chat on WhatsApp" src={WhatsAppButtonGreen} />
              </a>
          </section>
      </>
  );
